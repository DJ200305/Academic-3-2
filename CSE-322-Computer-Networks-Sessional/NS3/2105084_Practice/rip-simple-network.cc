...
main(int argc, char** argv)
{
    ...
    Names::Add("RouterE", e);
    NodeContainer net1(src, b);
    NodeContainer net2(a, b);
    NodeContainer net3(a, e);
    NodeContainer net4(e, c);
    NodeContainer net5(b, c);
    NodeContainer net6(c, d);
    NodeContainer net7(b, d);
    NodeContainer net8(d, dst);
    ...
    ripRouting.SetInterfaceMetric(b, 4, 6); 
    ripRouting.SetInterfaceMetric(d, 2, 6);

    ripRouting.SetInterfaceMetric(b, 3, 5);
    ripRouting.SetInterfaceMetric(c, 2, 5);

    ripRouting.SetInterfaceMetric(e, 2, 2);
    ...
    if (printRoutingTables)
    {
        ...
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(30), e, routingStream);
        ...
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(120), d, routingStream);
    }
